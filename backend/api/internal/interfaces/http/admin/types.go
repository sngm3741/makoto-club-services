...
func adminStoreDomainToResponse(store admindomain.Store) adminStoreResponse {
	return adminStoreResponse{
		...
		SNS: adminStoreSNSPayload{
			Twitter:   store.SNS.Twitter.String(),
			Line:      store.SNS.Line.String(),
			Instagram: store.SNS.Instagram.String(),
			TikTok:    store.SNS.TikTok.String(),
			Official:  store.SNS.Official.String(),
		},
